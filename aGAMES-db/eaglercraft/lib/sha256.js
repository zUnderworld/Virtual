...
!function(r, t) {
        ...
        case "TEXT":
            return function(r, t, n) {
                return function(r, t, n, i, e) {
                    var o, u, s, f, h, a, c, w, E = 0, v = n || [0], l = (i = i || 0) >>> 3;
                    if ("UTF8" === t)
                        for (c = -1 === e ? 3 : 0,
                        s = 0; s < r.length; s += 1)
                            for (u = [],
                            128 > (o = r.charCodeAt(s)) ? u.push(o) : 2048 > o ? (u.push(192 | o >>> 6),
                            u.push(128 | 63 & o)) : 55296 > o || 57344 <= o ? u.push(224 | o >>> 12, 128 | o >>> 6 & 63, 128 | 63 & o) : (s += 1,
                            o = 65536 + ((1023 & o) << 10 | 1023 & r.charCodeAt(s)),
                            u.push(240 | o >>> 18, 128 | o >>> 12 & 63, 128 | o >>> 6 & 63, 128 | 63 & o)),
                            f = 0; f < u.length; f += 1) {
                                for (h = (a = E + l) >>> 2; v.length <= h; )
                                    v.push(0);
                                v[h] |= u[f] << 8 * (c + e * (a % 4)),
                                E += 1
                            }
                        ...
                        for (c = -1 === e ? 2 : 0,
                        w = "UTF16LE" === t && 1 !== e || "UTF16LE" !== t && 1 === e,
                        s = 0; s < r.length; s += 1) {
                            for (o = r.charCodeAt(s),
                            !0 === w && (o = (f = 255 & o) << 8 | o >>> 8),
                            h = (a = E + l) >>> 2; v.length <= h; )
                                v.push(0);
                            v[h] |= o << 8 * (c + e * (a % 4)),
                            E += 2
                        }
        ...
        case "B64":
            return function(r, n, i) {
                return function(r, n, i, e) {
                    var o, u, s, f, h, a, c = 0, w = n || [0], E = (i = i || 0) >>> 3, v = -1 === e ? 3 : 0, l = r.indexOf("=");
                    ...
                    for (o = 0; o < r.length; o += 4) {
                        ...
                        for (u = 0; u < f.length - 1; u += 1) {
                            for (h = (a = c + E) >>> 2; w.length <= h; )
                                w.push(0);
                            w[h] |= (s >>> 16 - 8 * u & 255) << 8 * (v + e * (a % 4)),
                            c += 1
                        }
                    }
                    return {
        ...
        case "B64":
            return function(r) {
                return function(r, n, i, e) {
                    ...
                    for (o = 0; o < c; o += 3)
                        for (f = o + 1 < c ? r[o + 1 >>> 2] : 0,
                        h = o + 2 < c ? r[o + 2 >>> 2] : 0,
                        s = (r[o >>> 2] >>> 8 * (w + i * (o % 4)) & 255) << 16 | (f >>> 8 * (w + i * ((o + 1) % 4)) & 255) << 8 | h >>> 8 * (w + i * ((o + 2) % 4)) & 255,
                        u = 0; u < 4; u += 1)
                            a += 8 * o + 6 * u <= n ? t.charAt(s >>> 6 * (3 - u) & 63) : e.b64Pad;
                    return a
                }(r, e, o, u)
            }
            ;
    ...
    function a(r) {
        ...
        if (t.outputUpper = n.outputUpper || !1,
    ...
    function b(r, t) {
        ...
        a = t[7],
        R = 0; R < 64; R += 1)
            F[R] = R < 16 ? r[R] : A(c(m = F[R - 2], 17) ^ c(m, 19) ^ w(m, 10), F[R - 7], y(F[R - 15]), F[R - 16]),
    ...
    return function(t) {
        function n(r, n, i) {
            ...
            var u = i || {};
            return (e = t.call(this, r, n, i) || this).t = e.i,
            e.o = !0,
            e.u = -1,
            e.h = o(e.v, e.l, e.u),
            e.p = b,
            ...
            e.T = function(t, n, i, e) {
                return function(r, t, n, i, e) {
                    for (var o, u = 15 + (t + 65 >>> 9 << 4), s = t + n; r.length <= u; )
                        r.push(0);
            ...
            e.g = !1,
            u.hmacKey && e.B(function(r, t, n, i) {
        ...
        return r.prototype.update = function(r) {
            var t, n = 0, i = this.m >>> 5, e = this.h(r, this.H, this.Y), o = e.binLen, u = e.value, s = o >>> 5;
            for (t = 0; t < s; t += i)
                n + this.m <= o && (this.R = this.p(u.slice(t, t + i), this.R),
                n += this.m);
            return this.I += n,
            this.H = u.slice(n >>> 5),
            this.Y = o % this.m,
        ...
        r.prototype.getHash = function(r, t) {
            ...
            if (this.L && this.t)
                return s(this.t(o));
            for (i = this.T(this.H.slice(), this.Y, this.I, this.A(this.R), e),
            n = 1; n < this.numRounds; n += 1)
                this.g && e % 32 != 0 && (i[i.length - 1] &= 16777215 >>> 24 - e % 32),
        ...
        r.prototype.B = function(r) {
            ...
            for (n < r.binLen / 8 && (r.value = this.T(r.value, r.binLen, 0, this.U(this.S), this.F)); r.value.length <= i; )
                r.value.push(0);
            for (t = 0; t <= i; t += 1)
                this.N[t] = 909522486 ^ r.value[t],
                this.X[t] = 1549556828 ^ r.value[t];
            this.R = this.p(this.N, this.R),
            this.I = this.m,
            this.L = !0
        }
        ,
        ...
        r.prototype.i = function() {
            ...
            var t = this.T(this.H.slice(), this.Y, this.I, this.A(this.R), this.F);
            return r = this.p(this.X, this.U(this.S)),
