...
var locName='none';
var locPatches=[];
var locPlur='nplurals=2;plural=(n!=1);';
...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.jukebox={
			...
			setSound:function(id){
				...
				console.log(Game.jukebox.sounds[Game.jukebox.onSound], Game.jukebox.sounds)
	...
	Game.Logic=function()
	{
		...
		if (!Game.OnAscend && Game.AscendTimer==0)
		{
			...
			if (Game.T%(Game.fps*10)==0) Game.recalculateGains=1;
